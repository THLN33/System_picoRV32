...
//Device: GW2AR-18
//Device Version: C
//Created Time: Mon Mar  9 11:33:53 2026
...
wire [17:0] dpx9b_inst_0_douta;
wire [17:0] dpx9b_inst_0_doutb;
wire [17:0] dpx9b_inst_1_douta;
wire [17:0] dpx9b_inst_1_doutb;
wire [17:0] dpx9b_inst_2_douta;
wire [17:0] dpx9b_inst_2_doutb;
wire [17:0] dpx9b_inst_3_douta;
wire [17:0] dpx9b_inst_3_doutb;
wire dff_q_0;
wire dff_q_1;
wire dff_q_2;
wire dff_q_3;
...
DPX9B dpx9b_inst_0 (
    .DOA(dpx9b_inst_0_douta[17:0]),
    .DOB(dpx9b_inst_0_doutb[17:0]),
    .CLKA(clka),
    .OCEA(ocea),
    .CEA(cea),
    .RESETA(reseta),
...
DPX9B dpx9b_inst_1 (
    .DOA(dpx9b_inst_1_douta[17:0]),
    .DOB(dpx9b_inst_1_doutb[17:0]),
    .CLKA(clka),
    .OCEA(ocea),
    .CEA(cea),
    .RESETA(reseta),
...
DPX9B dpx9b_inst_2 (
    .DOA(dpx9b_inst_2_douta[17:0]),
    .DOB(dpx9b_inst_2_doutb[17:0]),
    .CLKA(clka),
    .OCEA(ocea),
    .CEA(cea),
    .RESETA(reseta),
...
defparam dpx9b_inst_2.BIT_WIDTH_0 = 18;
defparam dpx9b_inst_2.BIT_WIDTH_1 = 18;
defparam dpx9b_inst_2.BLK_SEL_0 = 3'b010;
defparam dpx9b_inst_2.BLK_SEL_1 = 3'b010;
defparam dpx9b_inst_2.RESET_MODE = "SYNC";

DPX9B dpx9b_inst_3 (
    .DOA(dpx9b_inst_3_douta[17:0]),
    .DOB(dpx9b_inst_3_doutb[17:0]),
    .CLKA(clka),
    .OCEA(ocea),
    .CEA(cea),
    .RESETA(reseta),
...
defparam dpx9b_inst_3.BIT_WIDTH_0 = 18;
defparam dpx9b_inst_3.BIT_WIDTH_1 = 18;
...
MUX2 mux_inst_27 (
  .O(mux_o_27),
  .I0(dpx9b_inst_0_douta[9]),
  .I1(dpx9b_inst_1_douta[9]),
  .S0(dff_q_1)
);
MUX2 mux_inst_28 (
  .O(mux_o_28),
...
MUX2 mux_inst_30 (
  .O(mux_o_30),
  .I0(dpx9b_inst_0_douta[10]),
  .I1(dpx9b_inst_1_douta[10]),
  .S0(dff_q_1)
);
MUX2 mux_inst_31 (
  .O(mux_o_31),
...
MUX2 mux_inst_33 (
  .O(mux_o_33),
  .I0(dpx9b_inst_0_douta[11]),
  .I1(dpx9b_inst_1_douta[11]),
  .S0(dff_q_1)
);
MUX2 mux_inst_34 (
  .O(mux_o_34),
...
MUX2 mux_inst_36 (
  .O(mux_o_36),
  .I0(dpx9b_inst_0_douta[12]),
  .I1(dpx9b_inst_1_douta[12]),
  .S0(dff_q_1)
);
MUX2 mux_inst_37 (
  .O(mux_o_37),
...
MUX2 mux_inst_39 (
  .O(mux_o_39),
  .I0(dpx9b_inst_0_douta[13]),
  .I1(dpx9b_inst_1_douta[13]),
  .S0(dff_q_1)
);
MUX2 mux_inst_40 (
  .O(mux_o_40),
...
MUX2 mux_inst_42 (
  .O(mux_o_42),
  .I0(dpx9b_inst_0_douta[14]),
  .I1(dpx9b_inst_1_douta[14]),
  .S0(dff_q_1)
);
MUX2 mux_inst_43 (
  .O(mux_o_43),
...
MUX2 mux_inst_45 (
  .O(mux_o_45),
  .I0(dpx9b_inst_0_douta[15]),
  .I1(dpx9b_inst_1_douta[15]),
  .S0(dff_q_1)
);
MUX2 mux_inst_46 (
  .O(mux_o_46),
...
MUX2 mux_inst_48 (
  .O(mux_o_48),
  .I0(dpx9b_inst_0_douta[16]),
  .I1(dpx9b_inst_1_douta[16]),
  .S0(dff_q_1)
);
MUX2 mux_inst_49 (
  .O(mux_o_49),
...
MUX2 mux_inst_51 (
  .O(mux_o_51),
  .I0(dpx9b_inst_0_douta[17]),
  .I1(dpx9b_inst_1_douta[17]),
  .S0(dff_q_1)
);
MUX2 mux_inst_52 (
  .O(mux_o_52),
...
MUX2 mux_inst_81 (
  .O(mux_o_81),
  .I0(dpx9b_inst_0_doutb[9]),
  .I1(dpx9b_inst_1_doutb[9]),
  .S0(dff_q_3)
);
MUX2 mux_inst_82 (
  .O(mux_o_82),
...
MUX2 mux_inst_84 (
  .O(mux_o_84),
  .I0(dpx9b_inst_0_doutb[10]),
  .I1(dpx9b_inst_1_doutb[10]),
  .S0(dff_q_3)
);
MUX2 mux_inst_85 (
  .O(mux_o_85),
...
MUX2 mux_inst_87 (
  .O(mux_o_87),
  .I0(dpx9b_inst_0_doutb[11]),
  .I1(dpx9b_inst_1_doutb[11]),
  .S0(dff_q_3)
);
MUX2 mux_inst_88 (
  .O(mux_o_88),
...
MUX2 mux_inst_90 (
  .O(mux_o_90),
  .I0(dpx9b_inst_0_doutb[12]),
  .I1(dpx9b_inst_1_doutb[12]),
  .S0(dff_q_3)
);
MUX2 mux_inst_91 (
  .O(mux_o_91),
...
MUX2 mux_inst_93 (
  .O(mux_o_93),
  .I0(dpx9b_inst_0_doutb[13]),
  .I1(dpx9b_inst_1_doutb[13]),
  .S0(dff_q_3)
);
MUX2 mux_inst_94 (
  .O(mux_o_94),
...
MUX2 mux_inst_96 (
  .O(mux_o_96),
  .I0(dpx9b_inst_0_doutb[14]),
  .I1(dpx9b_inst_1_doutb[14]),
  .S0(dff_q_3)
);
MUX2 mux_inst_97 (
  .O(mux_o_97),
...
MUX2 mux_inst_99 (
  .O(mux_o_99),
  .I0(dpx9b_inst_0_doutb[15]),
  .I1(dpx9b_inst_1_doutb[15]),
  .S0(dff_q_3)
);
MUX2 mux_inst_100 (
  .O(mux_o_100),
...
MUX2 mux_inst_102 (
  .O(mux_o_102),
  .I0(dpx9b_inst_0_doutb[16]),
  .I1(dpx9b_inst_1_doutb[16]),
  .S0(dff_q_3)
);
MUX2 mux_inst_103 (
  .O(mux_o_103),
...
MUX2 mux_inst_105 (
  .O(mux_o_105),
  .I0(dpx9b_inst_0_doutb[17]),
  .I1(dpx9b_inst_1_doutb[17]),
  .S0(dff_q_3)
);
MUX2 mux_inst_106 (
  .O(mux_o_106),
