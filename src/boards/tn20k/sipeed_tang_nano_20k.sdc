...
create_clock -name clk -period 20.833 [get_nets {clk}]

create_clock -name clk_hdmi_x5 -period 8.333 [get_nets {clk_hdmi_x5}]


//create_generated_clock -name clk_final -source [get_pins {dcs0/dcs_inst/CLK1}] [get_pins {dcs0/dcs_inst/CLKOUT}]